...
point_list = [
    ...
    (ip_address_1, 'analogInput:105', 'presentValue', BACnet_ref_1),
    #ChA Sound Speed
    (ip_address_1, 'analogInput:106', 'presentValue', BACnet_ref_1),
    #ChA Flow Rate & Diagnostics
    (ip_address_1, 'analogInput:111', 'presentValue', BACnet_ref_1),
    (ip_address_1, 'analogInput:111', 'eventState', BACnet_ref_1),
    (ip_address_1, 'analogInput:111', 'reliability', BACnet_ref_1),
    (ip_address_1, 'analogInput:111', 'outOfService', BACnet_ref_1),
    #ChA SNR
    (ip_address_1, 'analogInput:121', 'presentValue', BACnet_ref_1),
    #ChA SCNR
    (ip_address_1, 'analogInput:122', 'presentValue', BACnet_ref_1),
    #ChB Signal Amplitude
    (ip_address_1, 'analogInput:205', 'presentValue', BACnet_ref_1),
    #ChB Sound Speed
    (ip_address_1, 'analogInput:206', 'presentValue', BACnet_ref_1),
    #ChB Flow Rate & Diagnostics
    (ip_address_1, 'analogInput:211', 'presentValue', BACnet_ref_1),
    (ip_address_1, 'analogInput:211', 'eventState', BACnet_ref_1),
    (ip_address_1, 'analogInput:211', 'reliability', BACnet_ref_1),
    (ip_address_1, 'analogInput:211', 'outOfService', BACnet_ref_1),
    #ChB SNR
    (ip_address_1, 'analogInput:221', 'presentValue', BACnet_ref_1),
    #ChB SCNR
    (ip_address_1, 'analogInput:222', 'presentValue', BACnet_ref_1),
    #ChA Signal Amplitude
    (ip_address_2, 'analogInput:105', 'presentValue', BACnet_ref_2),
    #ChA Sound Speed
    (ip_address_2, 'analogInput:106', 'presentValue', BACnet_ref_2),
    #ChA Flow Rate & Diagnostics
    (ip_address_2, 'analogInput:111', 'presentValue', BACnet_ref_2),
    (ip_address_2, 'analogInput:111', 'eventState', BACnet_ref_2),
    (ip_address_2, 'analogInput:111', 'reliability', BACnet_ref_2),
    (ip_address_2, 'analogInput:111', 'outOfService', BACnet_ref_2),
    #ChA SNR
    (ip_address_2, 'analogInput:121', 'presentValue', BACnet_ref_2),
    #ChA SCNR
    (ip_address_2, 'analogInput:122', 'presentValue', BACnet_ref_2),
    #ChB Signal Amplitude
    (ip_address_2, 'analogInput:205', 'presentValue', BACnet_ref_2),
    #ChB Sound Speed
    (ip_address_2, 'analogInput:206', 'presentValue', BACnet_ref_2),
    #ChB Flow Rate & Diagnostics
    (ip_address_2, 'analogInput:211', 'presentValue', BACnet_ref_2),
    (ip_address_2, 'analogInput:211', 'eventState', BACnet_ref_2),
    (ip_address_2, 'analogInput:211', 'reliability', BACnet_ref_2),
    (ip_address_2, 'analogInput:211', 'outOfService', BACnet_ref_2),
    #ChB SNR
    (ip_address_2, 'analogInput:221', 'presentValue', BACnet_ref_2),
    #ChB SCNR
    (ip_address_2, 'analogInput:222', 'presentValue', BACnet_ref_2),
    #ChA Signal Amplitude
    (ip_address_3, 'analogInput:105', 'presentValue', BACnet_ref_3),
    #ChA Sound Speed
    (ip_address_3, 'analogInput:106', 'presentValue', BACnet_ref_3),
    #ChA Flow Rate & Diagnostics
    (ip_address_3, 'analogInput:111', 'presentValue', BACnet_ref_3),
    (ip_address_3, 'analogInput:111', 'eventState', BACnet_ref_3),
    (ip_address_3, 'analogInput:111', 'reliability', BACnet_ref_3),
    (ip_address_3, 'analogInput:111', 'outOfService', BACnet_ref_3),
    #ChA SNR
    (ip_address_3, 'analogInput:121', 'presentValue', BACnet_ref_3),
    #ChA SCNR
    (ip_address_3, 'analogInput:122', 'presentValue', BACnet_ref_3)
    ]
#
#   PrairieDog
#
